...
- **ЭТАП 8.11 / группа P5 — поиск во вкладке «Участники» (НОВАЯ СЕССИЯ).**
  ...
  NB: затем 8.12 (финальный деплой+приёмка), 8.13 (смена ссылки на таблицу — уточнить у заказчика
  ДО кода), Фаза 9 (overselling).
