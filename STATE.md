...
- **2026-06-27. ЭТАП 8.9 (модерация-канбан: 3 колонки + фильтр + Доской/Списком + флаг) — ЗАВЕРШЁН И ЗАДЕПЛОЕН (коммит `<DEPLOY>`).**
...
- **ЭТАП 8.9 (модерация-канбан) — ЗАВЕРШЁН И ЗАДЕПЛОЕН** (`<DEPLOY>`, см. «Текущая точка»).
